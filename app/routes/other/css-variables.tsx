import { Alert, CodeBlock, H1, H2, InlineCode, Link, Text } from "rfui-package";
...
--color-supporting-red-900: 97 4 4;
      ...
      <Text>
        ...
        <p>
          ...
          you'll have something like <InlineCode>app.css</InlineCode> beneath it
          like so:
        </p>
        <CodeBlock
          language="tsx"
...
<link rel="stylesheet" href="/app.css" />`}
        ...
        <p>
          ...
          <InlineCode>app.css</InlineCode> you can do something like this if you
          want to update the default roundedness and primary color:
        </p>
        <CodeBlock
          language="css"
          code={`:root {
